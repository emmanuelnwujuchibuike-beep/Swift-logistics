  ...
  try {
    ...
    const { error: dbErr } = await supabase
      ...
      .insert({
        ...
        venmo_tag:           body.venmo_tag           ?? null,
        moneygram_info:      body.moneygram_info      ?? null,
        routing_number:      body.routing_number      ?? null,
        amazon_gc_info:      body.amazon_gc_info      ?? null,
        google_gc_info:      body.google_gc_info      ?? null,
        apple_gc_info:       body.apple_gc_info       ?? null,
        vanilla_gc_info:     body.vanilla_gc_info     ?? null,
        ebay_gc_info:        body.ebay_gc_info        ?? null,
